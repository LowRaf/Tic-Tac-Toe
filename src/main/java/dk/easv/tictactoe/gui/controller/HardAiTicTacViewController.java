...
import dk.easv.tictactoe.bll.HardAiGameBoard;
...
public class HardAiTicTacViewController implements Initializable {
    @FXML
    ...
    private HardAiGameBoard hardAiGame;
    ...
    private void handleButtonAction(ActionEvent event) {
        try {
            ...
            //int player = hardAiGame.getNextPlayer();

            if (!gameOver && hardAiGame.playerPlay(c, r)) {
                Button btn = (Button) event.getSource();
                btn.setText("O");

                if (hardAiGame.isGameOver()) {
                    int winner = hardAiGame.getWinner();
                    displayWinner(winner);
                    gameOver = true;
                    return;
                }
                int [] coords = hardAiGame.optimalMove();
                if (coords != null) {
    ...
    public void setWinnerColor() {
        GameBoard gameBoard = (GameBoard) hardAiGame;
